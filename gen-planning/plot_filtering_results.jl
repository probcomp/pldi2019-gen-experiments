...
figure(figsize=(4,2))
plot_results(num_particles_list_custom, results_compiled_custom_proposal, "Custom Proposal", "orange")
plot_results(num_particles_list_default, results_compiled_default_proposal, "Default Proposal", "blue")
